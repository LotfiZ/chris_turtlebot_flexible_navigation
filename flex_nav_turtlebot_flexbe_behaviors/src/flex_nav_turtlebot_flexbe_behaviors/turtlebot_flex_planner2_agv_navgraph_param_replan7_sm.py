...
@author: Josh Cohen
'''
class TurtlebotFlexPlanner2_AGV_Navgraph_Param_replan7SM(Behavior):
	'''
	...
	def __init__(self):
		super(TurtlebotFlexPlanner2_AGV_Navgraph_Param_replan7SM, self).__init__()
		self.name = 'Turtlebot Flex Planner2_AGV_Navgraph_Param_replan7'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('New Plan',
										GetPathState(planner_topic="high_level_planner"),
										transitions={'planned': 'CHECK', 'empty': 'Receive Goal', 'failed': 'Continue'},
			...
			OperatableStateMachine.add('TEB',
										_sm_teb_0,
										transitions={'finished': 'Receive Goal', 'failed': 'failed', 'danger': 'AGVstop', 'preempted': 'Continue'},
										autonomy={'finished': Autonomy.Inherit, 'failed': Autonomy.Inherit, 'danger': Autonomy.Inherit, 'preempted': Autonomy.Inherit},
										remapping={'plan': 'plan'})
