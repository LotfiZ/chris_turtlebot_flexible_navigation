...
@author: Josh Cohen
'''
class TurtlebotFlexPlanner2_AGV_NavgraphSM(Behavior):
	'''
	...
	def __init__(self):
		super(TurtlebotFlexPlanner2_AGV_NavgraphSM, self).__init__()
		self.name = 'Turtlebot Flex Planner2_AGV_Navgraph'
