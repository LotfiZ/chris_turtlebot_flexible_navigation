...
@author: Josh Cohen
'''
class TurtlebotFlexPlanner2_AGV_Navgraph_Param_replan9SM(Behavior):
	'''
	...
	def __init__(self):
		super(TurtlebotFlexPlanner2_AGV_Navgraph_Param_replan9SM, self).__init__()
		self.name = 'Turtlebot Flex Planner2_AGV_Navgraph_Param_replan9'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('ClearCostmap',
										...
										transitions={'done': 'GetPose/Local', 'failed': 'failed'},
			...
			OperatableStateMachine.add('DWA',
										_sm_dwa_1,
										transitions={'finished': 'GetPose/Local', 'failed': 'AutoReplan', 'danger': 'AGVstop', 'preempted': 'Continue'},
			...
			OperatableStateMachine.add('Continue',
										...
										transitions={'yes': 'GetPose/Local', 'no': 'finished', 'recover': 'LogRecovery', 'clearcostmap': 'ClearCostmap'},
			...
			OperatableStateMachine.add('New Plan',
										GetPathState(planner_topic="high_level_planner"),
										transitions={'planned': 'check', 'empty': 'GetPose/Local', 'failed': 'Continue'},
			...
			OperatableStateMachine.add('TEB',
										_sm_teb_0,
										transitions={'finished': 'GetPose/Local', 'failed': 'failed', 'danger': 'AGVstop', 'preempted': 'Continue'},
										autonomy={'finished': Autonomy.Inherit, 'failed': Autonomy.Inherit, 'danger': Autonomy.Inherit, 'preempted': Autonomy.Inherit},
										remapping={'plan': 'plan'})
			...
			# x:192 y:91
			OperatableStateMachine.add('GetPose/Local',
			...
			OperatableStateMachine.add('check',
										...
										transitions={'True': 'DWA', 'False': 'TEB', 'Continue': 'Continue'},
										autonomy={'True': Autonomy.Off, 'False': Autonomy.Off, 'Continue': Autonomy.Off},
