...
@author: Josh Cohen
'''
class TurtlebotFlexPlanner2_AGV_places11_recoverySM(Behavior):
	'''
	...
	def __init__(self):
		super(TurtlebotFlexPlanner2_AGV_places11_recoverySM, self).__init__()
		self.name = 'Turtlebot Flex Planner2_AGV_places11_recovery'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('TEB',
										...
										transitions={'done': 'Log Success', 'failed': 'AutoReplan', 'preempted': 'Continue'},
