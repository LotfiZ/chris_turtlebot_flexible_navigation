...
@author: Josh Cohen
'''
class TurtlebotFlexPlanner2_AGV_places_ccccSM(Behavior):
	'''
	...
	def __init__(self):
		super(TurtlebotFlexPlanner2_AGV_places_ccccSM, self).__init__()
		self.name = 'Turtlebot Flex Planner2_AGV_places_cccc'
