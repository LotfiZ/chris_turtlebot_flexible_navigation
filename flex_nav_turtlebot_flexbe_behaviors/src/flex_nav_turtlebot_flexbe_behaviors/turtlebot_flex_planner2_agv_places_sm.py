...
@author: Josh Cohen
'''
class TurtlebotFlexPlanner2_AGV_placesSM(Behavior):
	'''
	...
	def __init__(self):
		super(TurtlebotFlexPlanner2_AGV_placesSM, self).__init__()
		self.name = 'Turtlebot Flex Planner2_AGV_places'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('CHECK',
										...
										autonomy={'True': Autonomy.High, 'False': Autonomy.Low, 'Continue': Autonomy.Full},
										remapping={'plan': 'plan'})
