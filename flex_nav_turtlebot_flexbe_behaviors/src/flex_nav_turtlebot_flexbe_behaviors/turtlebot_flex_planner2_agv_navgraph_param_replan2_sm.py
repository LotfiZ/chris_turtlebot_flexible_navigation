...
@author: Josh Cohen
'''
class TurtlebotFlexPlanner2_AGV_Navgraph_Param_replan2SM(Behavior):
	'''
	...
	def __init__(self):
		super(TurtlebotFlexPlanner2_AGV_Navgraph_Param_replan2SM, self).__init__()
		self.name = 'Turtlebot Flex Planner2_AGV_Navgraph_Param_replan2'
