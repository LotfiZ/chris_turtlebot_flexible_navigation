...
@author: Josh Cohen
'''
class TurtlebotFlexPlanner2_AGV_Navgraph_Param_replan8SM(Behavior):
	'''
	...
	def __init__(self):
		super(TurtlebotFlexPlanner2_AGV_Navgraph_Param_replan8SM, self).__init__()
		self.name = 'Turtlebot Flex Planner2_AGV_Navgraph_Param_replan8'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('DWA',
										_sm_dwa_1,
										transitions={'finished': 'getPose', 'failed': 'AutoReplan', 'danger': 'AGVstop', 'preempted': 'Continue'},
