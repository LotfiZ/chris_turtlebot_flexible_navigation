...
@author: Josh Cohen
'''
class TurtlebotFlexPlanner2_AGV_Navgraph_Param_ReplanSM(Behavior):
	'''
	...
	def __init__(self):
		super(TurtlebotFlexPlanner2_AGV_Navgraph_Param_ReplanSM, self).__init__()
		self.name = 'Turtlebot Flex Planner2_AGV_Navgraph_Param_Replan'
	...
	def create(self):
		...
		# x:35 y:227, x:172 y:223, x:394 y:276, x:537 y:18, x:471 y:282, x:547 y:181, x:544 y:99, x:674 y:184
		...
		with _sm_container_0:
			...
			OperatableStateMachine.add('SAFETY',
										agvstatusState(topic="/scan"),
										transitions={'hit': 'danger'},
										autonomy={'hit': Autonomy.Off})
