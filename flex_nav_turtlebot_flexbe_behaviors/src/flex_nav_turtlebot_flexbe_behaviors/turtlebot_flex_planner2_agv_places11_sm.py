...
@author: Josh Cohen
'''
class TurtlebotFlexPlanner2_AGV_places11SM(Behavior):
	'''
	...
	def __init__(self):
		super(TurtlebotFlexPlanner2_AGV_places11SM, self).__init__()
		self.name = 'Turtlebot Flex Planner2_AGV_places11'
